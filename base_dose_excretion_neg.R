...
## accelerating, linear, or decelerating, and where dose-excretion relationships
## are negative. We record the density of susceptible and infected
...
dilution.model <- function (t, x, params) {
  ...
  dPdt = (release1*(1/2 + P/(2*45.2381))^-3) * I1 + (release2*(1/2 + P/(2*45.2381))^-3) * I2 - degrade * P - feed1 * (S1 + I1) * P - feed2 * (S2 + I2) * P
...
write.csv(dilution_curve,"exc_neg.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_high_comp.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_low_comp.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_high_f.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_high_sus.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_low_sus.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_high_mort.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_low_mort.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_k_dec.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_k_lin.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"exc_neg_k_acc.csv")
