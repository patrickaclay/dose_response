...
## increasing but linear. We record the density of susceptible and infected
...
dilution.model <- function (t, x, params) {
  ...
  dI1dt = feed1 * inf1 * (P ^ K1) * S1 - mort1 * (P/45.23810) ^ 1.0 * I1
  dS2dt = (S2 + I2) * (r2 - intra * (S2+I2) - inter1on2 * (S1+I1)) - feed2 * inf2 * (P ^ K2) * S2
  dI2dt = feed2 * inf2 * (P ^ K2) * S2 - mort2 * (P/45.23810) ^ 1.0 * I2
...
write.csv(dilution_curve,"mort_lin.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_high_comp.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_low_comp.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_high_f.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_high_sus.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_low_sus.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_high_mort.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_low_mort.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_k_dec.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_k_lin.csv")
...
#Save data
dilution_curve <- as.data.frame(dilution_curve)
write.csv(dilution_curve,"mort_lin_k_acc.csv")
